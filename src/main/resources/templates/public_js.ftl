...
<!--      <script src="js/plugins/jquery-form/jquery.form.min.js"></script> -->
    ...
    <script src="js/plugins/bootstrap-table/bootstrap-table.min.js"></script><!-- 表格js -->
    <script src="js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"></script><!-- 表格中文支持js -->
    <script src="js/jquery.nicescroll.min.js"></script><!-- 自定义滚动条js -->
    ...
    <script type="text/javascript" src="js/plugins/bootstrap-select-1.12.2/bootstrap-select.js"></script>
     ...
     <script src="js/plugins/bootstrap-daterangepicker-master/moment.js" type="text/javascript" charset="utf-8"></script><!-- 日期区间 -->
 	 <script src="js/plugins/bootstrap-daterangepicker-master/daterangepicker.js" type="text/javascript" charset="utf-8"></script><!-- 日期区间 -->
